                ...
                <div className="slide1__front-background">
                    <div className="slide1__wrapper">
                        ...
                        <div className="slide1__wrapper-text">
                            Пройди тест и узнай, правильно ли ты заботишься о своем питомце, оцени свой уровень владельца и получи чек-лист с советами от экспертов.
                        </div>
                    ...
                    <div className="slide1__share">
                        ...
                        <div className="slide1__share-btns">
                            ...
                            <a href="#" className="slide1__share-btn share-btn share-btn_vk"
                                onClick={e => {
                                    e.preventDefault();
                                    window.open(`https://vk.com/share.php?url=${window.encodeURIComponent(window.location.href)}&title=${window.encodeURIComponent('Пройди тест и узнай, правильно ли ты заботишься о своем питомце, оцени свой уровень владельца и получи чек-лист с советами от экспертов.')}&image=${window.encodeURIComponent('https://kviz.karmypet.ru/shareImg/slide1__wrapper.png')}`, 'Опрос Квиз', 'width=640,height=480');
                                }}
                            ></a>
